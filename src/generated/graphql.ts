...
export type ProfileFollowsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type AuthenticateMutation = { __typename?: 'Mutation', authenticate?: { __typename?: 'AuthenticateResponse', identityCreated: boolean, token: string } | null };

export type MyProfileQueryVariables = Exact<{ [key: string]: never; }>;


export type MyProfileQuery = { __typename?: 'Query', myProfile?: { __typename?: 'Profile', id: string, username: string } | null };
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    ...
    MyProfile(variables?: MyProfileQueryVariables, options?: C): Promise<MyProfileQuery> {
      return requester<MyProfileQuery, MyProfileQueryVariables>(MyProfileDocument, variables, options) as Promise<MyProfileQuery>;
    }
  };
}
